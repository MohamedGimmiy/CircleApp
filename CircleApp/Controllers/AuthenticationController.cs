...
namespace CircleApp.Controllers
{
    public class AuthenticationController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginVM loginVM)
        {
            ...
            if(!existingUserClaims.Any(n => n.Type == CustomClaim.FullName))
            {
        ...
        public async Task<IActionResult> UpdatePassword(UpdatePasswordVM updatePasswordVM)
        {
            ...
            var isCurrentPasswordValid = await _userManager
                .CheckPasswordAsync(loggedInUser, updatePasswordVM.CurrentPassword);
        ...
        public IActionResult ExternalLogin(string provider)
        {
            ...
            if (provider == "GitHub")
            {
                properties.Items["scope"] = "user:email";
            }
        ...
        public async Task<IActionResult> ExternalLoginCallback()
        {
            ...
            if(user == null)
            {
                ...
                {
                    await _userManager.AddToRoleAsync(newUser, AppRoles.User);
                    await _userManager.AddClaimAsync(newUser, new Claim(CustomClaim.FullName,
                        newUser.FullName));
                    await _signInManager.SignInAsync(newUser, isPersistent: false);
                    return RedirectToAction("Index", "Home");
                }
